    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.11.4787\pertemuan8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                MessageBox.Show("Apakah Data mahasiswa ingin dihapus !", "Konfirmasi",
